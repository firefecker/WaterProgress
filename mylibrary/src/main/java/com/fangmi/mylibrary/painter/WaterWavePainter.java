 ...
 */
public class WaterWavePainter implements Painter {
    ...
    public WaterWavePainter(int color, Context context, float spacing) {
        this.color = color;
    ...
    public void draw(Canvas canvas) {
        ...
        bgPaint.setColor(Color.parseColor("#425481"));
        // 绘制背景

 ...
 */
public class ProgressPainter2 implements Painter {
    ...
    public ProgressPainter2(int color, float max, int margin, Context context, float strokeWidth) {
        this.color = color;
        this.max = max;
    ...
    public void setValue(int value) {
        int angle = (int) ((360 * value) / max / 2);
        this.plusAngle = -angle;
    }
}